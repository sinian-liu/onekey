...
echo -e "\033[1;32m服务器推荐：https://my.frantech.ca/aff.php?aff=4337\033[0m"
echo -e "\033[1;32mVPS评测官方网站：https://www.1373737.xyz/\033[0m"
echo -e "\033[1;32mYouTube频道：https://www.youtube.com/@cyndiboy7881\033[0m"
echo -e "\033[1;33m=============================================\033[0m"

echo -e "\033[1;33m请选择要执行的操作：（请输入对应的数字）\033[0m"
...
echo -e "\033[1;33m6. 无人直播云SRS安装\033[0m"
echo -e "\033[1;33m7. 宝塔纯净版安装\033[0m"
echo -e "\033[1;33m8. 长时间保持 SSH 会话连接不断开\033[0m"
echo -e "\033[1;33m9. 重启服务器\033[0m"
