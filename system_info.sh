...
if [[ -n "$PUBLIC_IP" ]]; then
    echo "报告可以通过以下网址下载：http://$PUBLIC_IP:$PORT/test_report.html"
else
    echo "无法获取公网 IP，报告已生成在 $REPORT_FILE，请手动下载。"
fi
